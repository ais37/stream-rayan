...
const devs = ['439102535693762582']; // ايدي الشخص اللي يغير الستريم والصورة ولاسم

const adminprefix = "3" //برفكس الستريم وتغيير الصورة والاسم

const prefix = "3"; //برفكس البوت هنا
/////////////////////////
////////////////////////
...
client.on('message', message => {
    if (message.content === (prefix + 'help')) {
        ...
        .setDescription('**${prefix} بركس البوت**')
